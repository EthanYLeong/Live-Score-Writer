...
public class PartLink {
     ...
     * This is why there is not a <CODE>set</CODE> method for the instrumentLink property.
     * 
     * <p>
    ...
    public List<InstrumentLink> getInstrumentLink() {
        if (instrumentLink == null) {
            instrumentLink = new ArrayList<InstrumentLink>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the groupLink property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<java.lang.String> getGroupLink() {
        if (groupLink == null) {
            groupLink = new ArrayList<java.lang.String>();
        }
