...
public class Sound {
     ...
     * This is why there is not a <CODE>set</CODE> method for the instrumentChangeAndMidiDeviceAndMidiInstrument property.
     * 
     * <p>
    ...
    public List<Object> getInstrumentChangeAndMidiDeviceAndMidiInstrument() {
        if (instrumentChangeAndMidiDeviceAndMidiInstrument == null) {
            instrumentChangeAndMidiDeviceAndMidiInstrument = new ArrayList<Object>();
        }
